...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.axion.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.axion.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.axion.releasetype";
    ...
    public static final String PROP_DISPLAY_VERSION = "ro.axion.display.version";
